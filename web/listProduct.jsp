        ...
        <div class="header scrolling" id="myHeader">
            <div class="grid wide">
                <div class="header__top">
                    ...
                    <a href="listProduct.jsp" class="header__logo">
                    ...
                    <div class="header__search">
                        ...
                        <!--                        <form action="MainController">
                                                        ...
                                                        <input type="text" name="search" class="header__search-input" placeholder="Tìm kiếm" value="<%= search%>"/>
                                                        <input type="hidden" name="action" value="SearchProduct"/>
                                                        <a class="header__search-icon" href="MainController?action=SearchProduct&search=${search}">
                    ...
                    <%
                        if (user != null) {
                    %>
                    <a class="ViewOrder" href="MainController?action=ViewOrderUser&userID=${LOGIN_USER.getUserID()}" style="font-size: larger;" >View Order</a>
                    <%
                        }
                    %>
            ...
            <div class="header__nav">
                <ul class="header__nav-list">
                    ...
                    <li class="header__nav-item index">
                        <a href="MainController?action=ShopingPage" class="header__nav-link">Trang chủ</a>
                    </li>
                ...
                <div class="main__taskbar">
                    <div class="main__breadcrumb">
                        <div class="breadcrumb__item">
                            <a href="MainController?action=ShopingPage" class="breadcrumb__link">Trang chủ</a>
                        </div>
                        <div class="breadcrumb__item">
                                        ...
                                        <c:if test="${product.quantity>=0}">
                                            ...
                                            <div class="col l-2 m-4 s-6">
                                                <div class="product">
                                                    ...
                                                    <a href="MainController?action=Add&cmbQuantity=1&cmbComestics=${product.id}-${product.name.replaceAll("\\s", "")}-${product.price}&img=${product.img}" class="addToCart">Thêm vào giỏ</a>
                                                </div>
                                            </div>
                                        </c:if>
                                    </c:forEach>
