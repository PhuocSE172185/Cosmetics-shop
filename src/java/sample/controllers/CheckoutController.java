...
public class CheckoutController extends HttpServlet {
    ...
    private static final String SUCCESS = "MainController?action=ShoppingPage";
            ...
            if (session != null) {
                if (cart != null) {
                    for (Comestic co : cart.getCart().values()) {
                        if (co.getQuantity() == 0) {
                            request.setAttribute("MESSAGES", "Quantity can not is = 0");
                    ...
                    if (orderID != null) {
                        ...
                        request.setAttribute("MESSAGE", "The product is out of stock");
                    }
                } else {
