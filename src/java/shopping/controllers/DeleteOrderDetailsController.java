...
public class DeleteOrderDetailsController extends HttpServlet {
    ...
    private static final String ERROR = "ViewOrderDetailsController";
    private static final String SUCCESS = "ViewOrderDetailsController";
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            dao.DeleteOrderdetails(orderID, productID, quantity, price);
            url = SUCCESS;
        } catch (Exception e) {
